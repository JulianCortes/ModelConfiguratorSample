...
{
    //Classe preso di peso da VRUtilities
    ...
    public class InputDetection : MonoBehaviour
    {
        ...
        [SerializeField]
        private float m_MinimumSwipeDistance = 0.4f;
        ...
        private SwipeDirection DetectSwipe()
        {
            ...
            float distance = Vector2.Distance(m_MouseUpPosition, m_MouseDownPosition);
            ...
            if (Mathf.Abs(distance) < m_MinimumSwipeDistance) return SwipeDirection.NONE;
